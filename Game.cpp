...
void Game::Render() const
{
	...
	if (bricks.size() == 0)
	{
		Console::WordWrap(10,10,10, "Victory ( You win ) Press R to reset ");
	}
	...
	if (ball.y_position > paddle.y_position )
	{
		...
		Console::WordWrap(20, 20,20, "Defeat(Just Log Off) Press R to reset ");

		//Console.  //(10,10,"Defeat(Just Log Off) Press R to reset \n");
